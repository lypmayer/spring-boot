...
public class EnTask extends TableImpl<EnTaskRecord> {
    ...
    private static final long serialVersionUID = 298940418;

    /**
     * The reference instance of <code>task.en_task</code>
     */
    ...
    /**
     * The column <code>task.en_task.seq_task</code>.
     */
    ...
    /**
     * The column <code>task.en_task.title</code>.
     */
    public final TableField<EnTaskRecord, String> TITLE = createField("title", org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false), this, "");

    /**
     * The column <code>task.en_task.description</code>.
     */
    public final TableField<EnTaskRecord, String> DESCRIPTION = createField("description", org.jooq.impl.SQLDataType.VARCHAR(500).nullable(false), this, "");

    /**
     * The column <code>task.en_task.seq_en_status</code>.
     */
    public final TableField<EnTaskRecord, Long> SEQ_EN_STATUS = createField("seq_en_status", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * Create a <code>task.en_task</code> table reference
     */
    public EnTask() {
    ...
    /**
     * Create an aliased <code>task.en_task</code> table reference
     */
